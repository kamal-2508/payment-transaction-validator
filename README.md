...
Built with a full pytest test suite (66 test cases) and GitHub Actions CI pipeline.
...
├── tests/
│   └── test_validator.py     # 66 pytest test cases
├── .github/
│   └── workflows/
...
## Getting Started
```bash
git clone https://github.com/kamal-2508/payment-transaction-validator.git
